...
<!-- left menu starts -->
<%
    if(Integer.parseInt(session.getAttribute("lid").toString())==1){
...
<div class="box-content">
    ...
    <fieldset>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-xlarge focused" id="oldpass" type="password">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-xlarge focused" id="newpass1" type="password">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="newpass2">确认新密码：</label>
            <div class="controls">
                <input class="input-xlarge focused" id="newpass2" type="password" >
            </div>
        </div>
