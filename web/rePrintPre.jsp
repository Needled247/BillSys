...
<div class="box-content">
    ...
    <fieldset>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-xlarge focused" id="longNum" type="text">
            </div>
        </div>
        <hr>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="input-xlarge focused" id="account" type="text">
            </div>
        </div>
        <div class="form-actions">
            <button type="button" class="btn btn-primary" onclick="reprint()">确定</button>
        </div>
    </fieldset>
    </form>
</div>
