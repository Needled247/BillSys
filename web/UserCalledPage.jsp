...
<div class="container-fluid">
        ...
        <div id="content" class="span10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="ViewUser.jsp">查看用户</a><span class="divider">/</span>
                    </li>
                    <li>查看详细通话记录</li>
                </ul>
            </div>
    ...
    <input type="hidden" id="longNum" value="<%=request.getParameter("longNum")%>">
    <input type="hidden" id="shortNum" value="<%=request.getParameter("shortNum")%>">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="input-append">
                            ...
                            <button type="button" class="btn btn-success" onclick="getThisMonthCalled()"  data-rel="popover" data-content="查看该用户本月的通话记录。" title="提示">本月</button>
                            <button type="button" class="btn btn-warning" onclick="getAllCalled()"  data-rel="popover" data-content="查看该用户全部的通话记录。" title="提示">全部</button>
                        </div>
                        <hr>
                        <div class="input-append">
                            <h3>时间段查询：</h3>
                            ...
                            <button class="btn btn-primary" type="button" onclick="window.open('exportUserCalled.jsp');"  data-rel="popover" data-content="目前计费功能只能计算单月数据，暂时不能计算多月的通话费用，如果需要导出通话记录请在“查询通话记录”中导出。" title="提示">导出结果</button>
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="box-content">
                    <div id="UserCalledTblBlock" class="dataTables_wrapper" role="grid">
                        <table class="table table-striped table-bordered bootstrap-datatable datatable dataTable" id="UserCalledTbl" aria-describedby="DataTables_Table_0_info" style="width: 100%">
                            <thead>
                            <tr role="row">
                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">主叫</th>
                                ...
                                <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending">开始时间</th>
