...
<div class="span2 main-menu-span">
    <div class="well nav-collapse sidebar-nav" id="menu">
        <ul class="nav nav-tabs nav-stacked main-menu">
            ...
            <li><a class="ajax-link" href="log.jsp"><i class="icon-th"></i><span class="hidden-tablet">系统日志</span></a></li>
            <li class="nav-header hidden-tablet">系统</li>
            <li><a class="ajax-link" href="Manager.jsp"><i class="icon-folder-open"></i><span class="hidden-tablet"> 管理员管理</span></a></li>
